...
-- Step 1: Identify the last trading day of each month per ticker.
...
create or replace view derived_fundamentals as

-- Compute derived financial metrics from raw fundamental data.
